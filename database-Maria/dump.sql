...
) ENGINE=InnoDB AUTO_INCREMENT=297005121 DEFAULT CHARSET=utf8;
...
INSERT INTO `Borrower` (`borrowerId`, `username`, `email`, `flagged`) VALUES (1,'abc1234','abc1234',1),(2,'abcics','abcics',0),(3,'ab1234','ab1234',0),(4,'axb1234','axb1234',0),(5,'acd1234','acd1234',0),(6,'add1234','add1234',0),(7,'abb1234','abb1234',0),(8,'aqs1234','aqs1234',0),(9,'addics','addics',0),(10,'a11111','abc1234',0),(11,'abc2234','abc2234',1),(12,'abc2234','abc2234',1),(13,'abc2234','abc2234',1),(14,'abc2234','abc2234',1),(100,'abc1234','abc1234',1),(200,'abc1234','abc1234',1),(300,'abc300','abc300',0),(301,'abc1234','abc1234',0),(302,'abc1234','email',0),(303,'abc1234','email',0),(304,'abc12345','email',0),(305,'abc123456','email2',0),(306,'abc1234567','email3',0),(311,'abc1234','abc1234',0),(297005120,'abc2234','abc2234',0);
/*!40000 ALTER TABLE `Borrower` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Borrower_has_Class`
--

DROP TABLE IF EXISTS `Borrower_has_Class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Borrower_has_Class` (
  `Borrower_borrowerId` int(11) NOT NULL,
  `Class_classId` int(11) NOT NULL,
  PRIMARY KEY (`Borrower_borrowerId`,`Class_classId`),
  KEY `fk_Borrower_has_Class1_Class1_idx` (`Class_classId`),
  KEY `fk_Borrower_has_Class1_Borrower1_idx` (`Borrower_borrowerId`),
  CONSTRAINT `fk_Borrower_has_Class1_Borrower1` FOREIGN KEY (`Borrower_borrowerId`) REFERENCES `Borrower` (`borrowerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Borrower_has_Class1_Class1` FOREIGN KEY (`Class_classId`) REFERENCES `Class` (`classId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Borrower_has_Class`
--

LOCK TABLES `Borrower_has_Class` WRITE;
/*!40000 ALTER TABLE `Borrower_has_Class` DISABLE KEYS */;
INSERT INTO `Borrower_has_Class` (`Borrower_borrowerId`, `Class_classId`) VALUES (1,1),(1,2),(2,1),(11,7),(13,2),(14,1),(300,7),(297005120,2);
/*!40000 ALTER TABLE `Borrower_has_Class` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Borrower_has_Major`
--

DROP TABLE IF EXISTS `Borrower_has_Major`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Borrower_has_Major` (
  `Borrower_borrowerId` int(11) NOT NULL,
  `Major_majorID` int(11) NOT NULL,
  PRIMARY KEY (`Borrower_borrowerId`,`Major_majorID`),
  KEY `fk_Borrower_has_Major1_Major1_idx` (`Major_majorID`),
  KEY `fk_Borrower_has_Major1_Borrower1_idx` (`Borrower_borrowerId`),
  CONSTRAINT `fk_Borrower_has_Major1_Borrower1` FOREIGN KEY (`Borrower_borrowerId`) REFERENCES `Borrower` (`borrowerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Borrower_has_Major1_Major1` FOREIGN KEY (`Major_majorID`) REFERENCES `Major` (`majorID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Borrower_has_Major`
--

LOCK TABLES `Borrower_has_Major` WRITE;
/*!40000 ALTER TABLE `Borrower_has_Major` DISABLE KEYS */;
INSERT INTO `Borrower_has_Major` (`Borrower_borrowerId`, `Major_majorID`) VALUES (13,10),(14,1),(14,10),(300,5),(297005120,1);
/*!40000 ALTER TABLE `Borrower_has_Major` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Item` (
  ...
  CONSTRAINT `fk_Item_ItemType1` FOREIGN KEY (`ItemType_itemTypeId`) REFERENCES `ItemType` (`itemTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Item_has_Damage` (
  ...
  KEY `fk_Item_has_Damage_Damage1_idx` (`Damage_damageId`),
  KEY `fk_Item_has_Damage_Item1_idx` (`Item_idItem`),
  CONSTRAINT `fk_Item_has_Damage_Damage1` FOREIGN KEY (`Damage_damageId`) REFERENCES `Damage` (`damageId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Item_has_Damage_Item1` FOREIGN KEY (`Item_idItem`) REFERENCES `Item` (`idItem`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Item_has_Damage` (`Item_idItem`, `Damage_damageId`) VALUES (1,1),(20,4),(21,5),(22,6),(23,7),(24,8),(25,10),(31,10),(33,10),(33,13);
...
CREATE TABLE `Item_has_Warranty` (
  ...
  KEY `fk_Item_has_Warranty_Warranty1_idx` (`Warranty_warrentyId`),
  KEY `fk_Item_has_Warranty_Item1_idx` (`Item_idItem`),
  CONSTRAINT `fk_Item_has_Warranty_Item1` FOREIGN KEY (`Item_idItem`) REFERENCES `Item` (`idItem`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Item_has_Warranty_Warranty1` FOREIGN KEY (`Warranty_warrentyId`) REFERENCES `Warranty` (`warrentyId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Item_has_Warranty` (`Item_idItem`, `Warranty_warrentyId`) VALUES (1,1),(20,3),(21,4),(22,5),(23,6),(24,7),(25,8),(29,8),(30,8);
...
CREATE TABLE `Rental` (
  ...
  KEY `fk_Rental_Student1_idx` (`Borrower_borrowerId`),
  CONSTRAINT `fk_Rental_Student1` FOREIGN KEY (`Borrower_borrowerId`) REFERENCES `Borrower` (`borrowerId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Rental_has_Item` (
  ...
  KEY `fk_Rental_has_Item_Item1_idx` (`Item_idItem`),
  KEY `fk_Rental_has_Item_Rental1_idx` (`Rental_rentalId`,`Rental_Student_studentId`),
  CONSTRAINT `fk_Rental_has_Item_Item1` FOREIGN KEY (`Item_idItem`) REFERENCES `Item` (`idItem`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Rental_has_Item_Rental1` FOREIGN KEY (`Rental_rentalId`, `Rental_Student_studentId`) REFERENCES `Rental` (`rentalId`, `Borrower_borrowerId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Rental_has_Item` (`Rental_rentalId`, `Rental_Student_studentId`, `Item_idItem`) VALUES (2,1,2),(41,1,5),(45,1,5),(46,1,5),(48,2,5),(49,2,5),(50,2,5),(59,4,5),(60,4,2),(63,300,11),(70,300,2),(70,300,3),(80,7,1),(80,7,2),(80,7,3),(81,7,1),(81,7,2),(81,7,3),(103,8,3),(103,8,10);
...
CREATE TABLE `Reservation` (
  ...
  KEY `fk_Reservervation_Borrower1_idx` (`Borrower_borrowerId`),
  KEY `fk_Reservervation_Rental1_idx` (`Rental_rentalId`),
  KEY `fk_Reservervation_ItemType1_idx` (`ItemType_itemTypeId`),
  CONSTRAINT `fk_Reservervation_Borrower1` FOREIGN KEY (`Borrower_borrowerId`) REFERENCES `Borrower` (`borrowerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Reservervation_ItemType1` FOREIGN KEY (`ItemType_itemTypeId`) REFERENCES `ItemType` (`itemTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Reservervation_Rental1` FOREIGN KEY (`Rental_rentalId`) REFERENCES `Rental` (`rentalId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Section` (
  ...
  CONSTRAINT `fk_table2_Class1` FOREIGN KEY (`Class_classId`) REFERENCES `Class` (`classId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-05-02  3:30:45
